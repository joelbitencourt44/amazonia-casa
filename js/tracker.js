  ...
  content.innerHTML = `
    ...
    <div style="background:#f9f9f9;border-radius:10px;padding:1.5rem;">
      <div style="display:flex;align-items:center;gap:0.5rem;margin-bottom:0.8rem;">
        ...
        <div><strong>Origem:</strong><p style="margin:0;color:#666;">${product.origin || "Não informado"}</p></div>
      </div>
      <div style="display:flex;align-items:center;gap:0.5rem;margin-bottom:0.8rem;">
        <span style="font-size:1.5rem;">👤</span>
        <div><strong>Extrativista:</strong><p style="margin:0;color:#666;">${product.producer || "Não informado"}</p></div>
      </div>
      <div style="display:flex;align-items:center;gap:0.5rem;margin-bottom:0.8rem;">
        <span style="font-size:1.5rem;">📅</span>
        <div><strong>Data da Coleta:</strong><p style="margin:0;color:#666;">${product.date || "Não informado"}</p></div>
      </div>
      <div style="display:flex;align-items:center;gap:0.5rem;margin-bottom:0.8rem;">
        <span style="font-size:1.5rem;">🌳</span>
        <div><strong>Área Preservada:</strong><p style="margin:0;color:#666;">${product.area || "Não informado"}</p></div>
      </div>
      ${
        product.benefits
          ? `
      <div style="display:flex;align-items:center;gap:0.5rem;margin-bottom:0.8rem;">
        <span style="font-size:1.5rem;">✨</span>
        <div><strong>Benefícios:</strong><p style="margin:0;color:#666;">${product.benefits}</p></div>
      </div>`
          : ""
      }
    </div>
